...
| `draft-board-500.html` | Filterable web board (overall + per-position views, tier strategy, status flags) |
| `top150.py` / `tail.py` / `notes.py` / `build.py` | Source data and the script that assembles the board |
